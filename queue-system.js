// 🔥 CM QUEUEHUB - CENTRALIZED CLOUD QUEUE SYSTEM v5.0 (Firebase Live Sync Patched)
...
// 2. Paste your exact credentials from your Firebase Console here
...
class QueueHubSystem {
    ...
    async joinQueue(userType = "student", explicitName = null, explicitId = null, explicitPurpose = null, uniqueSessionId = null) {
        try {
            ...
            const prefix = userType === "visitor" ? "V-" : "S-";
    ...
    async terminateService(windowNumber, resolutionStatus = "Completed") {
        ...
        const historyRef = ref(db, "cmQueueData/logsHistory");
        const newLogRef = push(historyRef);
        await set(newLogRef, logRecord);
